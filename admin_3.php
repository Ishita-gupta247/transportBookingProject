...
$price =$_POST['price'] ;
$sql = "INSERT INTO category (name,type,station1,destination,price,startTime,endTime,startDate,endDate,cstatus) VALUES ('$name','$type','$station1','$destination','$price','$startTime','$endTime','$startDate','$endDate','success')";
...
?>
<h1> Schedule is created successfully!!!  </h1> 
<?php
}
?>
</form>
