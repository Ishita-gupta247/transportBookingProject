...
.topnav-right {
  ...
  <div class="topnav-right">
    ...
    <a href="oldschedule.php" class="nav-link active">oldSchedule</a>
  </div>
</div>
    <br><br><br>
...
session_start();
$id = $_POST['id'];
$s="UPDATE category SET cstatus = 'cancel' WHERE id='$id'";
$sq="UPDATE booking SET status = 'cancel' WHERE categoryId='$id'";
$mysqli->query($s ) ;
$mysqli->query($sq ) ;
// Check connection
...
?>
<h1> Schedule is cancelled successfully!!!  </h1> 
